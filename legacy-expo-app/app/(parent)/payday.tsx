...
export default function PaydayScreen() {
  ...
  const bucketTemplateDeps = bucketTemplates.map(bt => bt.id).join('|');
  ...
  }, [payDeps, bucketTemplateDeps, bucketTemplates]);
            ...
            <Card.Content>
              <View style={styles.cardHeader}>
                ...
                <View style={styles.totalBadge}>
                  <Text variant="titleMedium" style={styles.totalBadgeText}>
                    ${total.toFixed(2)}
                  </Text>
                </View>
              </View>
...
const styles = StyleSheet.create({
  ...
  totalBadgeText: { fontWeight: '800', color: '#12313A' },
